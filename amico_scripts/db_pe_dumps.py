...
cursor.execute("""
    ...
    (sha, md5, timestamp, srcip, dstip, method, url, host, referer, server,
...
# Disabled feature cache and calling feature generation script from
# process_dump.sh
"""
if dump_id is not None:
    if feature_cache.check_feature_exists(cursor, dump_id, host, sha):
        feature_cache.copy_features(cursor, dump_id, host, sha)
"""
