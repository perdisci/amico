#! /usr/bin/python
###########################################################################
# Copyright (C) 2012 Babak Rahbarinia and Phani Vadrevu                   #
# babak@cs.uga.edu, pvadrevu@uga.edu                                      #
#                                                                         #
...
"""
This is the version of psql2arff.py file to be used for online test scripts.
Differences:
1. It doesnot keep any "unknown" labels and
instead leaves a "?" mark in the place of class labels
2. It does not depend on benign_thresh_trusted variable as it was used during
offline batch testing.
3. It does not look at corrupt variable as it is being ignored for online
case
"""
...
convert_nulls = config.getboolean('classifier', 'convert_nulls')
is_benign_thresh_trusted = config.getboolean('classifier', 'is_benign_thresh_trusted')
convert_to = str(config.getint('classifier', 'convert_to'))
